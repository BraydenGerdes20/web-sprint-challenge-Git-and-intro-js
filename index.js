...
function addArtist(array) {
  array.push({id: 20, name: 'Brayden Gerdes', years: 2002-2022, genre: 'web Design', nationality: 'White', bio: 'Just living long enough to see the world become greater.'});
  return array;
}
...
*/
function artistInfo(array, info){
  const artInfo = [];
  for(let i = 0; i < array.length; i++){
    if(array[i].name === info){
